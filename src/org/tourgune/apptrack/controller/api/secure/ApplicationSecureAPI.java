package org.tourgune.apptrack.controller.api.secure;
...
import org.tourgune.apptrack.bean.Aplicacion;
import org.tourgune.apptrack.bean.Visor;
import org.tourgune.apptrack.facade.ApplicationFacade;
import org.tourgune.apptrack.facade.DeveloperFacade;
import org.tourgune.apptrack.facade.PuntoFacade;
import org.tourgune.apptrack.facade.VariableFacade;
import org.tourgune.apptrack.facade.VisorFacade;
...
public class ApplicationSecureAPI {
	 ...
	 */
	@RequestMapping(value = "/visor", method = RequestMethod.DELETE)
	public @ResponseBody
	String deleteVisorisores(
			@RequestParam(value = "idvisor", required = false) Integer idvisor) {
