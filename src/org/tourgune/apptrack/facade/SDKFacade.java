package org.tourgune.apptrack.facade;
...
import org.tourgune.apptrack.dao.SDKDao;
...
public class SDKFacade {
	...
	public Integer createPoint2(Punto point, int idUser) {
		return sdkDao.createPoint2(point, idUser);
	}
	...
	public Integer createUserEmo(int idUser, int idApp) {
		return sdkDao.createUserEmo(idUser, idApp);
	}
	...
	public Integer existUser(int idUser, int idApp) {
		return sdkDao.existUser(idUser, idApp);
	}
	...
	public int createValueEmo(Emotions emo) {
		return sdkDao.createValueEmo(emo);
	}
}
